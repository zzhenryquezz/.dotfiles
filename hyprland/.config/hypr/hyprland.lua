...
local monitorPrimary = "DVI-D-1"
local monitorSecondary = "HDMI-A-1"
...
hl.monitor({
	output   = monitorPrimary,
	mode     = "3840x2160@30",
	position = "0x0",
	scale    = monitor1.scale,
})

hl.monitor({
	output   = monitorSecondary,
	mode     = "1920x1080@60",
	scale    = monitor2.scale,
})
...
hl.config({
	...
	cursor = {
		default_monitor=monitorPrimary,
		inactive_timeout = 0,
